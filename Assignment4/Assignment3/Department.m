...
-(Vehicle *) modifyVehicle:(NSString *) vehicleName{
    ...
    Vehicle *returnVehicle=nil;
    for(Vehicle *v in _vehicles){
        if([v.make isEqualToString:vehicleName]){
            returnVehicle=v;
        }
    }
...
- (id)initWithCoder:(NSCoder *)coder {
    ...
    self.dealer = [coder decodeObjectForKey:@"dealer"];
    [[NSUserDefaults standardUserDefaults] setObject:[NSKeyedArchiver archivedDataWithRootObject:_vehicles] forKey:@"vehicles"];
    [[NSUserDefaults standardUserDefaults] setObject:[NSKeyedArchiver archivedDataWithRootObject:_employees] forKey:@"employees"];
    return self;
}
...
- (void)encodeWithCoder:(NSCoder *)aCoder {
    ...
    [aCoder encodeObject:_dealer forKey:@"dealer"];
    [aCoder encodeObject:_vehicles forKey:@"vehicles"];
    [aCoder encodeObject:_employees forKey:@"employees"];
